...
journalist_with_num = []
    ...
    puts "Notre base de données de la mort contient #{aude.length} fois le prenom aude."
    puts "#{maj_deb.length} handle commencent par une majuscule."
...
# def journalist_search (handle, journalist_with_num)
#     for i in 0...10
#         if handle.include? "#{i}"
#             journalist_with_num << handle
#         end
...
# annonce_journalist_length
# annonce_handle_with_num_length